                    ...
                    <div class="col-md-9 relative clear-padding">
                        ...
                        <div class="bar-category bottom-margin-default border no-border-r no-border-l no-border-t">
                            <div class="row">
                                <div class="col-md-5 col-sm-5 col-xs-4">
                                    <p class="title-category-page clear-margin"></p>
                                </div>
                        ...
                        <div class="row">
                           @if(count($data['products'])>0)
                                    ...
                                    <div
                                        ...
                                        <div class="image-product relative overfollow-hidden">
                                            <div class="center-vertical-image">
                                                <a href="{{route('urun.detay',['slug'=>$prod->product_slug])}}"> <img
                                                        width="265" src="/images/products/{{$prod->photo}}"></a>
                                            </div>


                                        </div>
                                        <h3 class="title-product clearfix full-width title-hover-black"><a
                                                href=""></a>{{$prod->product_name}}</h3>
                                ...
                                @endforeach
                            @else
                               <h3 align="center">Aradığın Ürünü Bulamadık</h3>
                               @endif
